...
<body>
	<header>
		<div id="logo"><img src="image/i5.png" width="80" height="80" alt="" id="name"><?php echo " ACCUEIL( logo + titre)"; ?></div><!-- LOGO + MACHINE A FILMS DESIGNER -->		
	</header>
	<main >
	...
	<!-- AVEC DESIGN -->
	<?php echo "PAGE DE CONNEXION UTILISATEURS "; ?>			
	</div>
...
<footer>
	...
	<?php echo "PAGE DE CONNEXION UTILISATEURS avec logo + footer"; ?>
